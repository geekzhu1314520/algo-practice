...
/**
 * @author zhujiashuai
 * @date: 2024/2/20 14:53
 * @description:
 */
public class MergeKListsTest extends UnitTestBase {
    ...
    public void mergeKListsV1_case1() {
        ...
        MergeKLists.ListNode[] lists = new MergeKLists.ListNode[]{node1, node4};
    ...
    public void mergeKListsV1_case2() {
        ...
        MergeKLists.ListNode[] lists = new MergeKLists.ListNode[]{node1, node3, node6};
